...
/**
 * tree_is_perfect - function that check if a tree is perfect or not
 * @tree: the tree to be check
 * Return: 0 on success
 */
...
/**
 * binary_tree_is_perfect - function that perfect or not a tree
 * @tree: the tree to be check
 * Return: 0 on success
 */
 ...
 * @tree: the tree to be check
 * Return: 1 if tree is a valid Max Binary Heap, and 0 otherwise. If
