 ...
 * @node: the pointer of node to be created
 ...
 * @node: the pointer of node of the tree
 * @head: the head node of in the stack
 * @tail: the tail node of in the stack
 */
...
/**
 * binary_tree_is_complete - function that checks if a binary tree
 * is complete
